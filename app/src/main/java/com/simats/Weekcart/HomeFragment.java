...
public class HomeFragment extends Fragment {
    ...
    private void fetchHealthScore() {
        ApiInterface apiService = NetworkClient.getClient(getContext()).create(ApiInterface.class);
        apiService.getHealthScore().enqueue(new Callback<com.simats.Weekcart.models.HealthScoreResponse>() {
            @Override
            public void onResponse(Call<com.simats.Weekcart.models.HealthScoreResponse> call, Response<com.simats.Weekcart.models.HealthScoreResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
            ...
            @Override
            public void onFailure(Call<com.simats.Weekcart.models.HealthScoreResponse> call, Throwable t) {
    ...
    private void fetchRecentBills() {
        ...
        apiService.getBills().enqueue(new Callback<List<com.simats.Weekcart.models.Bill>>() {
            @Override
            public void onResponse(Call<List<com.simats.Weekcart.models.Bill>> call, Response<List<com.simats.Weekcart.models.Bill>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    List<com.simats.Weekcart.models.Bill> bills = response.body();
