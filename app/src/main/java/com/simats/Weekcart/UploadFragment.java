...
public class UploadFragment extends Fragment {
    ...
    private void fetchBillHistory() {
        ...
        apiService.getBills().enqueue(new Callback<List<com.simats.Weekcart.models.Bill>>() {
            @Override
            public void onResponse(Call<List<com.simats.Weekcart.models.Bill>> call,
                    Response<List<com.simats.Weekcart.models.Bill>> response) {
            ...
            @Override
            public void onFailure(Call<List<com.simats.Weekcart.models.Bill>> call, Throwable t) {
    ...
    private void uploadBill() {
        ...
        try {
            ...
            ApiInterface apiService = NetworkClient.getClient(getContext()).create(ApiInterface.class);
            apiService.uploadBill(body).enqueue(new Callback<com.simats.Weekcart.models.Bill>() {
                @Override
                public void onResponse(Call<com.simats.Weekcart.models.Bill> call,
                        Response<com.simats.Weekcart.models.Bill> response) {
                    if (response.isSuccessful() && response.body() != null) {
                ...
                @Override
                public void onFailure(Call<com.simats.Weekcart.models.Bill> call, Throwable t) {
    ...
    private void showProcessedState(com.simats.Weekcart.models.Bill bill) {
        llProcessingState.setVisibility(View.GONE);
        llSelectedState.setVisibility(View.VISIBLE);
        ...
        if (bill.getItems() != null && !bill.getItems().isEmpty()) {
            for (com.simats.Weekcart.models.BillItem item : bill.getItems()) {
