        ...
        apiService.getNotifications().enqueue(new Callback<List<Notification>>() {
            ...
            public void onResponse(Call<List<Notification>> call, Response<List<Notification>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    if (com.simats.frontend.adapters.NotificationAdapter.class != null) {
                        com.simats.frontend.adapters.NotificationAdapter adapter = new com.simats.frontend.adapters.NotificationAdapter(
                                response.body());
